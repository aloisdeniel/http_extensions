...
class ExtendedClient extends http.BaseClient {
  ...
  Future<http.Response> putWithOptions(url,
          {Map<String, String>? headers, body, List<dynamic>? options, Encoding? encoding}) =>
  ...
  Future<http.Response> formWithOptions(
    ...
    request.headers
        .addAll({if (headers != null) ...headers, HttpHeaders.contentTypeHeader: 'application/x-www-form-urlencoded'});
